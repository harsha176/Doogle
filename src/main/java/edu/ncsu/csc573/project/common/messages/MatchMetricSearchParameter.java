 ...
 * 
 */
public class MatchMetricSearchParameter implements IParameter {
	/**
	...
	public void add(PublishSearchParameter pubSearchParam) {
		...
		while (pubSearchParam.getParamCount() < pubSearchParam.getSize()) {
			...
			this.add(EnumParamsType.MATCHMETRIC,
					pubSearchParam.getParamValue(EnumParamsType.MATCHMETRIC));
