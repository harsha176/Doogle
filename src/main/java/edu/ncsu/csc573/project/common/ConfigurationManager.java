...
public class ConfigurationManager {
	...
	private static final String DEFAULT_DOWNLOAD_DIRECTORY = "/tmp";
	private static final String DEFAULT_PUBLISH_DIRECTORY = "/tmp";
		...
		if (confManager == null) {
			...
			try {
				config.load(ClassLoader
						.getSystemResourceAsStream(CONFIGURATION_PROPERTIES));
			} catch (IOException e) {
